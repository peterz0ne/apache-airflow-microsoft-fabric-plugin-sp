...
@provide_session
def update_conn(conn_id, client_secret: str, session=None):
...
class FabricHook(BaseHook):
    ...
    def _get_token(self) -> str:
        ...
        update_conn(self.conn_id, client_secret)
...
class FabricAsyncHook(FabricHook):
    ...
    async def _async_get_token(self) -> str:
        ...
        await sync_to_async(update_conn)(self.conn_id, client_secret)
